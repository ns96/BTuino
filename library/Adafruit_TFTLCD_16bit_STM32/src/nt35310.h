...
/*****************************************************************************/
extern void nt35310_begin(void);
extern void nt35310_setAddrWindow(int16_t x1, int16_t y1, int16_t x2, int16_t y2);
extern void nt35310_fillScreen(uint16_t color);
extern void nt35310_drawPixel(int16_t x, int16_t y, uint16_t color);
extern void nt35310_setRotation(uint8_t x);
extern uint16_t nt35310_readPixel(int16_t x, int16_t y);
extern void nt35310_invertDisplay(bool i);
